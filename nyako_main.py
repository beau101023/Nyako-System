...
# starts main loop
from nyako_params import FramesPerBuffer
stream = audio.open(rate=16000, channels=1, input=True, format=pyaudio.paFloat32, frames_per_buffer=FramesPerBuffer, stream_callback=microphoneInputCallback)
